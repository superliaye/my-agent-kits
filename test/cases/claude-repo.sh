...
assert_file_exists "$WORK/.claude/skills/thermo-nuclear-code-quality-review/SKILL.md" "thermo-nuclear-code-quality-review skill deployed"
assert_file_exists "$WORK/.claude/skills/tdd/SKILL.md" "tdd skill deployed"
assert_file_exists "$WORK/.claude/skills/tdd/tests.md" "tdd companion file (tests.md) deployed"
assert_file_exists "$WORK/.claude/skills/caveman/SKILL.md" "caveman skill deployed"
