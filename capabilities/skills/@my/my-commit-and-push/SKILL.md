...
After the commit succeeds, push the branch to its remote tracking branch. If the branch has not been pushed before, set the upstream branch and write a change description following the rules below.
