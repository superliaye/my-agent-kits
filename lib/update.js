...
export async function runUpdate({ flags, repoDir, kitRoot }) {
  ...
  let adopted = { instructions: [], prompts: [], skills: [], plugins: [], mcp: [], hooks: [] };
...
function computeNewInPreset(preset, all, state) {
  ...
  const out = { instructions: [], prompts: [], skills: [], plugins: [], mcp: [], hooks: [] };
...
function applyPrimitiveOps(base, adopted, removedQualified) {
  const out = JSON.parse(JSON.stringify(base ?? { instructions: [], prompts: [], skills: [], plugins: [], mcp: [], hooks: [] }));
