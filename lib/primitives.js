...
// APM-package layout (matches microsoft/apm conventions; APM auto-discovers
// from .apm/* with root *.prompt.md as a fallback used by the hello-world
// template. We standardize on .apm/* for symmetry — verified equivalent in
// `docker run --rm my-agent-kits-test`):
//   .apm/instructions/*.instructions.md   — instructions
//   .apm/prompts/*.prompt.md              — slash-command prompts
//   skills/<name>/SKILL.md                — skills (folder per skill, under skills/)
...
const TYPE_LOCATIONS = {
  ...
  skills:       { dir: "skills",             suffix: "",                 isDir: true  },
