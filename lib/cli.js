...
export function helpText() {
  return [
    ...
    "",
    "Usage:",
    "  agent-kit init [TARGET] [--preset NAME[,NAME2]] [--agents claude,codex] [--scope repo|global] [--primitives '+x,-y'] [--bundles name1,name2] [--codex-personal-layer] [--claude-md overwrite|concat|skip]",
