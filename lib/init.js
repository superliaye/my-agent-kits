...
// it's the "empty start" preset, useless when combined. Filtered against the
// actually-available list at call time so renaming a preset can't strand a
// stale name here.
const DEFAULT_SELECTED_PRESETS = ["engineering", "productivity", "feature-loop"];
